...
// GET MIN VALUE, DATE
$query = "SELECT value, date FROM T_TEMPERATURE WHERE date BETWEEN '{$start}' AND '{$end}'";
...
// GET AVERAGE
$query = "SELECT AVG(value) AS ave FROM T_TEMPERATURE WHERE date BETWEEN '{$start}' AND '{$end}'";
$result = mysqli_query($conn, $query);
