...
// GET MIN VALUE, DATE
$query = "SELECT value, date FROM T_MOISTURE WHERE date BETWEEN '{$start}' AND '{$end}'";
...
// GET AVERAGE
$query = "SELECT AVG(value) AS ave FROM T_MOISTURE WHERE date BETWEEN '{$start}' AND '{$end}'";
$result = mysqli_query($conn, $query);
