...
const char *ssid = "Iphone 13 Bro Fold Max RTX 9000"; // ENTER YOUR WIFI NAME
const char *password = "";                            // ENTER YOUR WIFI PASSWORD
const char *host1 = "http://172.20.10.2/EasyGame/servers/database/Getstatus.php";
const char *host2 = "http://172.20.10.2/EasyGame/servers/data/getData.php";
...
{                          // Declare object of class HTTPClient
  ...
  while (datacontrol.available() <= 0)
    ; // cho nhan du lieu tu Node 1
